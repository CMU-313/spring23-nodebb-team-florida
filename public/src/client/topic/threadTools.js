...
define("forum/topic/threadTools", [
    ...
    ThreadTools.init = function (tid, topicContainer) {
        ...
        topicContainer.on(
            ...
            function () {
                alerts.success(
                    "You have reached this function, at src/client/topic/threadTools"
                );
                const btn = $(this);
        ...
        topicContainer.on(
            "click",
            '[component="topic/reading-all"]',
            function () {
                alerts.success(
                    "You clicked reading-all button! In src/client/topic/threadtools.js"
                );
