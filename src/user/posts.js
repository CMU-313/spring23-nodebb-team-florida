...
module.exports = function (User) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (userData.mutedUntil > now) {
                ...
                if (muteLeft > 60) {
                    ...
                    throw new Error(
                        `[[error:user-muted-for-hours, ${muteLeft}]]`
                    );
                } else {
                    throw new Error(
                        `[[error:user-muted-for-minutes, ${+muteLeft.toFixed(
                            0
                        )}]]`
                    );
                }
            ...
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
            if (
                now - userData.joindate <
                meta_1.default.config.initialPostDelay * 1000
            ) {
                // The next line calls a function in a module that has not been updated to TS yet
                // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
            ...
            // The next line calls a function in a module that has not been updated to TS yet
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
            const newbiepostdelaythreshold =
                meta_1.default.config.newbiePostDelayThreshold;
            // The next line calls a function in a module that has not been updated to TS yet
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
            ...
            if (
                ...
                // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
                throw new Error(
                    `[[error:too-many-posts-newbie, ${newbiepostdelay}, ${newbiepostdelaythreshold}]]`
                );
                // The next line calls a function in a module that has not been updated to TS yet
                // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
            } else if (
                now - lasttime <
                meta_1.default.config.postDelay * 1000
            ) {
                // The next line calls a function in a module that has not been updated to TS yet
                // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    ...
    User.updatePostCount = (uids) =>
        __awaiter(this, void 0, void 0, function* () {
            ...
            if (uids.length) {
                // The next line calls a function in a module that has not been updated to TS yet
                // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call
                const counts = yield database_1.default.sortedSetsCard(
                    uids.map((uid) => `uid:${uid}:posts`)
                );
                yield Promise.all([
                    // The next line calls a function in a module that has not been updated to TS yet
                    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access,@typescript-eslint/no-unsafe-call
                    database_1.default.setObjectBulk(
                        uids.map((uid, index) => [
                            `user:${uid}`,
                    ...
                    // The next line calls a function in a module that has not been updated to TS yet
                    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access,@typescript-eslint/no-unsafe-call
                    database_1.default.sortedSetAdd(
                        "users:postcount",
                        counts,
                        uids
                    ),
    ...
    User.incrementUserPostCountBy = function (uid, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield incrementUserFieldAndSetBy(
                uid,
                "postcount",
                "users:postcount",
                value
    ...
    User.getPostIds = function (uid, start, stop) {
        return __awaiter(this, void 0, void 0, function* () {
            // The next line calls a function in a module that has not been updated to TS yet
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call
            return yield database_1.default.getSortedSetRevRange(
                `uid:${uid}:posts`,
                start,
                stop
            );
