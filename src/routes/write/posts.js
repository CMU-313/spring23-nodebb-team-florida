...
module.exports = function () {
    ...
    setupApiRoute(router, 'put', '/:pid/readinglist', [...middlewares, middleware.assert.post], controllers.write.posts.readinglist);
    setupApiRoute(router, 'delete', '/:pid/readinglist', [...middlewares, middleware.assert.post], controllers.write.posts.unreadinglist);
